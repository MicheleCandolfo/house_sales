---
title: "KingCounty_Data_preparation_visualization_correlation"
author: "l.sommer"
date: "18 11 2021"
...
#Daten einlesen und ausgeben --> Überblick verschaffen
...
house_prices3$basement <- (ifelse(house_prices3$sqft_basement>0,1,0))
house_prices3$renovated <- (ifelse(house_prices3$yr_renovated>0,1,0))
house_prices3
```
##Visualisierung der numerischen Variablen 
### Pearson-Korrelation
...
scale_x_continuous(labels = scales::comma)+
  ...
  ggtitle('Price Distribution')
```
## SQft_living Korrelation: 0.70190928
```{r sqft_living}
...
dim(house_prices4)
```
## Sqft_lot Korrelation: 0.089881781 --> unbedeutend
```{r sqft_lot}
...
#Choosing features
house_prices5=house_prices4[,c("price","bedrooms","bathrooms","floors","waterfront","view","grade","condition","yr_built", "sqm_living","sqm_above", "basement","sqm_lot15", "sqm_living15" ,"lat", "long", "renovated")]
